...
//go:generate minimock -i github.com/RSODA/todo-go/internal/service.Service -o service_minimock.go -n ServiceMock -p mocks
...
func (mmCreate *mServiceMockCreate) Expect(ctx context.Context, b *models.TODO) *mServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ServiceMockCreateParams{ctx, b}
...
// ExpectBParam2 sets up expected param b for Service.Create
func (mmCreate *mServiceMockCreate) ExpectBParam2(b *models.TODO) *mServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mServiceMockCreate) Inspect(f func(ctx context.Context, b *models.TODO)) *mServiceMockCreate {
...
func (mmCreate *mServiceMockCreate) Return(tp1 *models.TODO, err error) *ServiceMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.results = &ServiceMockCreateResults{tp1, err}
	mmCreate.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmCreate.mock
}

// Set uses given function f to mock the Service.Create method
func (mmCreate *mServiceMockCreate) Set(f func(ctx context.Context, b *models.TODO) (tp1 *models.TODO, err error)) *ServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mServiceMockCreate) When(ctx context.Context, b *models.TODO) *ServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ServiceMockCreateParams{ctx, b},
...
func (e *ServiceMockCreateExpectation) Then(tp1 *models.TODO, err error) *ServiceMock {
	e.results = &ServiceMockCreateResults{tp1, err}
	return e.mock
}
...
func (mmCreate *ServiceMock) Create(ctx context.Context, b *models.TODO) (tp1 *models.TODO, err error) {
	...
	mm_params := ServiceMockCreateParams{ctx, b}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockCreateParams{ctx, b}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.b != nil && !minimock.Equal(*mm_want_ptrs.b, mm_got.b) {
				mmCreate.t.Errorf("ServiceMock.Create got unexpected parameter b, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to ServiceMock.Create. %v %v", ctx, b)
	return
}
